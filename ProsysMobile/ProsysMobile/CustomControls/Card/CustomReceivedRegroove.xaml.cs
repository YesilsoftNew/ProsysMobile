...
namespace WiseMobile.CustomControls.Card
{
    ...
    public partial class CustomReceivedRegroove : PancakeView
    {
        #region properties
        ...
        /// <summary>
        /// The RegroooveArea property.
        /// </summary>
        public static readonly BindableProperty RegroooveAreaProperty = BindableProperty.Create(
            nameof(RegroooveArea),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
            BindingMode.TwoWay);
        ...
        /// RegroooveArea value
        /// </summary>
        public string RegroooveArea
        {
            get
            {
                return (string)GetValue(RegroooveAreaProperty);
            }

            set
            {
                SetValue(RegroooveAreaProperty, value);
            }
        }
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            else if (propertyName == RegroooveAreaProperty.PropertyName)
            {
                lblRegroooveArea.Text = RegroooveArea;
            }
