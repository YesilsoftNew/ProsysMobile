...
namespace ProsysMobile.CustomControls.Card
{
    ...
    public partial class CustomTireActionDeMounting : PancakeView
    {
        #region properties
        ...
        /// <summary>
        /// The DeMountingPlate property.
        /// </summary>
        public static readonly BindableProperty DeMountingPlateProperty = BindableProperty.Create(
            nameof(DeMountingPlate),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
            BindingMode.TwoWay);
        ...
        /// <summary>
        /// The DeMountingReason property.
        /// </summary>
        public static readonly BindableProperty DeMountingReasonProperty = BindableProperty.Create(
            nameof(DeMountingReason),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
            BindingMode.TwoWay);
        ...
        /// <summary>
        /// DeMountingPlate value
        /// </summary>
        public string DeMountingPlate
        {
            get
            {
                return (string)GetValue(DeMountingPlateProperty);
            }

            set
            {
                SetValue(DeMountingPlateProperty, value);
            }
        }
        ...
        /// <summary>
        /// DeMountingReason value
        /// </summary>
        public string DeMountingReason
        {
            get
            {
                return (string)GetValue(DeMountingReasonProperty);
            }

            set
            {
                SetValue(DeMountingReasonProperty, value);
            }
        }
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            else if (propertyName == DeMountingPlateProperty.PropertyName)
            {
                lblDemountingPlate.Text = DeMountingPlate;
            }
            ...
            else if (propertyName == DeMountingReasonProperty.PropertyName)
            {
                lblDeMountingReason.Text = DeMountingReason;
            }
        ...
        public CustomTireActionDeMounting()
        {
            InitializeComponent();
        }
    }
