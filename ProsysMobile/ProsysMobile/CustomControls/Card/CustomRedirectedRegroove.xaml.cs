...
namespace ProsysMobile.CustomControls.Card
{
    ...
    public partial class CustomRedirectedRegroove : PancakeView
    {
        #region properties
        ...
        /// <summary>
        /// The RegrooveInfo property.
        /// </summary>
        public static readonly BindableProperty RegrooveInfoProperty = BindableProperty.Create(
            nameof(RegrooveInfo),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
        ...
        /// RegrooveInfo value
        /// </summary>
        public string RegrooveInfo
        {
            get
            {
                return (string)GetValue(RegrooveInfoProperty);
            }

            set
            {
                SetValue(RegrooveInfoProperty, value);
            }
        }
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            else if (propertyName == RegrooveInfoProperty.PropertyName)
            {
                lblRegrooveInfo.Text = RegrooveInfo;
            }
        ...
        public CustomRedirectedRegroove()
        {
            InitializeComponent();
        }
    }
