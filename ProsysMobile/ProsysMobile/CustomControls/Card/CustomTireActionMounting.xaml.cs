...
using System;
using ProsysMobile.CustomControls.Bar;
...
namespace ProsysMobile.CustomControls.Card
{
    ...
    public partial class CustomTireActionMounting : PancakeView
    {
        #region properties
        ...
        /// </summary>
        public static readonly BindableProperty AirPressureProperty = BindableProperty.Create(
            nameof(AirPressure),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
        ...
        public string AirPressure
        {
            get
            {
                return (string)GetValue(AirPressureProperty);
            }

            set
            {
                SetValue(AirPressureProperty, value);
            }
        }
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            else if (propertyName == AirPressureProperty.PropertyName)
            {
                lblAirPressure.Text = AirPressure;
            }
        ...
        public CustomTireActionMounting()
        {
            InitializeComponent();
        }
    }
