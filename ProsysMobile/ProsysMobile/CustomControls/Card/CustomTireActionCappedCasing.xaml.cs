...
namespace WiseMobile.CustomControls.Card
{
    ...
    public partial class CustomTireActionCappedCasing : PancakeView
    {
        #region properties
        /// <summary>
        ...
        /// <summary>
        /// The CappedCasing property.
        /// </summary>
        public static readonly BindableProperty CappedCasingProperty = BindableProperty.Create(
            nameof(CappedCasing),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
        ...
        /// CappedCasing value
        /// </summary>
        public string CappedCasing
        {
            get
            {
                return (string)GetValue(CappedCasingProperty);
            }

            set
            {
                SetValue(CappedCasingProperty, value);
            }
        }
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            else if (propertyName == CappedCasingProperty.PropertyName)
            {
                lblCappedCasing.Text = CappedCasing;
            }
        ...
        public CustomTireActionCappedCasing()
        {
            InitializeComponent();
        }
    }
