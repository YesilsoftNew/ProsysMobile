...
namespace WiseMobile.CustomControls.Card
{
    ...
    public partial class CustomTireActionStockEntry : PancakeView
    {
        #region properties
        /// <summary>
        ...
        /// <summary>
        /// The EntryStockCenter property.
        /// </summary>
        public static readonly BindableProperty EntryStockCenterProperty = BindableProperty.Create(
            nameof(EntryStockCenter),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
            BindingMode.TwoWay);
        ...
        /// </summary>
        public string EntryStockCenter
        {
            get
            {
                return (string)GetValue(EntryStockCenterProperty);
            }

            set
            {
                SetValue(EntryStockCenterProperty, value);
            }
        }
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            else if (propertyName == EntryStockCenterProperty.PropertyName)
            {
                lblEntryStockCenter.Text = EntryStockCenter;
            }
        ...
        public CustomTireActionStockEntry()
        {
            InitializeComponent();
        }
    }
