...
namespace ProsysMobile.CustomControls.Card
{
    ...
    public partial class CustomTireActionInspection : PancakeView
    {
        ...
        /// </summary>
        public static readonly BindableProperty ObservationProperty = BindableProperty.Create(
            nameof(Observation),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            try
            {
                ...
                else if (propertyName == ObservationProperty.PropertyName)
                {
        ...
        public CustomTireActionInspection()
        {
            try
            {
            InitializeComponent();
