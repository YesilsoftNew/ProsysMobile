...
namespace WiseMobile.CustomControls.Card
{
    ...
    public partial class CustomRedirectRegrooveList : PancakeView
    {
        #region properties
        ...
        /// <summary>
        /// The Regroove property.
        /// </summary>
        public static readonly BindableProperty RegrooveProperty = BindableProperty.Create(
            nameof(Regroove),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
        ...
        /// Regroove value
        /// </summary>
        public string Regroove
        {
            get
            {
                return (string)GetValue(RegrooveProperty);
            }

            set
            {
                SetValue(RegrooveProperty, value);
            }
        }
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            else if (propertyName == RegrooveProperty.PropertyName)
            {
                lblRegroove.Text = Regroove;
            }
        ...
        public CustomRedirectRegrooveList()
        {
            InitializeComponent();
        }
    }
