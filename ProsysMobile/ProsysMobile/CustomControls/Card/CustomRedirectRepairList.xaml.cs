...
namespace WiseMobile.CustomControls.Card
{
    ...
    public partial class CustomRedirectRepairList : PancakeView
    {
        #region properties
        ...
        /// The Date property.
        /// </summary>
        public static readonly BindableProperty RepairProperty = BindableProperty.Create(
            nameof(Date),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
        ...
        public string Repair
        {
            get
            {
                return (string)GetValue(RepairProperty);
            }

            set
            {
                SetValue(RepairProperty, value);
            }
        }
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            else if (propertyName == RepairProperty.PropertyName)
            {
        ...
        public CustomRedirectRepairList()
        {
            InitializeComponent();
        }
    }
