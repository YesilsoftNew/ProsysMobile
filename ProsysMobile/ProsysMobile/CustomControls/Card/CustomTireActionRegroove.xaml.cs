...
namespace ProsysMobile.CustomControls.Card
{
    ...
    public partial class CustomTireActionRegroove : PancakeView
    {
        #region properties
        /// <summary>
        ...
        /// <summary>
        /// The AfterRegroove property.
        /// </summary>
        public static readonly BindableProperty AfterRegrooveDepthProperty = BindableProperty.Create(
            nameof(AfterRegrooveDepth),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
            BindingMode.TwoWay);
        ...
        /// <summary>
        /// The RegrooveDepth property.
        /// </summary>
        public static readonly BindableProperty RegrooveDepthProperty = BindableProperty.Create(
            nameof(RegrooveDepth),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
            BindingMode.TwoWay);
        ...
        /// <summary>
        /// AfterRegrooveDepth value
        /// </summary>
        public string AfterRegrooveDepth
        {
            get
            {
                return (string)GetValue(AfterRegrooveDepthProperty);
            }

            set
            {
                SetValue(AfterRegrooveDepthProperty, value);
            }
        }
        ...
        /// RegrooveDepth value
        /// </summary>
        public string RegrooveDepth
        {
            get
            {
                return (string)GetValue(RegrooveDepthProperty);
            }

            set
            {
                SetValue(RegrooveDepthProperty, value);
            }
        }
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            else if (propertyName == RegrooveDepthProperty.PropertyName)
            {
                lblRegrooveDepth.Text = RegrooveDepth;
            }
            else if (propertyName == AfterRegrooveDepthProperty.PropertyName)
            {
                lblAfterRegrooveDepth.Text = AfterRegrooveDepth;
            }
        ...
        public CustomTireActionRegroove()
        {
            InitializeComponent();
        }
    }
