...
namespace WiseMobile.CustomControls.Card
{
    ...
    public partial class CustomTireActionRepair : PancakeView
    {
        #region properties
        /// <summary>
        ...
        /// <summary>
        /// The RepirType property.
        /// </summary>
        public static readonly BindableProperty RepirTypeProperty = BindableProperty.Create(
            nameof(RepirType),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
        ...
        /// <summary>
        /// The PatchCount property.
        /// </summary>
        public static readonly BindableProperty PatchCountProperty = BindableProperty.Create(
            nameof(PatchCount),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
        ...
        public string PatchCount
        {
            get
            {
                return (string)GetValue(PatchCountProperty);
            }

            set
            {
                SetValue(PatchCountProperty, value);
            }
        }
        ...
        /// RepirType value
        /// </summary>
        public string RepirType
        {
            get
            {
                return (string)GetValue(RepirTypeProperty);
            }

            set
            {
                SetValue(RepirTypeProperty, value);
            }
        }
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            else if (propertyName == RepirTypeProperty.PropertyName)
            {
                lblRepirType.Text = RepirType;
            }
            else if (propertyName == PatchCountProperty.PropertyName)
            {
                lblPatchCount.Text = PatchCount;
            }
