...
namespace WiseMobile.CustomControls.Card
{
    ...
    public partial class CustomReceivedCappedCasing : PancakeView
    {
        ...
        /// <summary>
        /// The AppliedCappedCasing property.
        /// </summary>
        public static readonly BindableProperty AppliedCappedCasingProperty = BindableProperty.Create(
            nameof(AppliedCappedCasing),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
            BindingMode.TwoWay);
        ...
        /// </summary>s
        public static readonly BindableProperty IsDataManagementProperty = BindableProperty.Create(
            nameof(IsDataManagement),
            typeof(bool),
            typeof(CustomTireActionNewBuy),
            default(bool),
            BindingMode.TwoWay);
        ...
        /// <summary>
        /// AppliedCappedCasing value
        /// </summary>
        public string AppliedCappedCasing
        {
            get
            {
                return (string)GetValue(AppliedCappedCasingProperty);
            }

            set
            {
                SetValue(AppliedCappedCasingProperty, value);
            }
        }
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            else if (propertyName == AppliedCappedCasingProperty.PropertyName)
            {
                lblAppliedCappedCasing.Text = AppliedCappedCasing;
            }
        ...
        public CustomReceivedCappedCasing()
        {
            InitializeComponent();
        }
    }
