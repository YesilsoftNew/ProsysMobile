...
namespace WiseMobile.CustomControls.Card
{
    ...
    public partial class CustomReceivedRepair : PancakeView
    {
        #region properties
        ...
        /// <summary>
        /// The AppliedRepair property.
        /// </summary>
        public static readonly BindableProperty AppliedRepairProperty = BindableProperty.Create(
            nameof(AppliedRepair),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
            BindingMode.TwoWay);
        ...
        /// AppliedRepair value
        /// </summary>
        public string AppliedRepair
        {
            get
            {
                return (string)GetValue(AppliedRepairProperty);
            }

            set
            {
                SetValue(AppliedRepairProperty, value);
            }
        }
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            else if (propertyName == AppliedRepairProperty.PropertyName)
            {
                lblAppliedRepair.Text = AppliedRepair;
            }
