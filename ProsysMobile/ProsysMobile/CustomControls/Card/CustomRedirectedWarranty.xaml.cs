...
namespace WiseMobile.CustomControls.Card
{
    ...
    public partial class CustomRedirectedWarranty : PancakeView
    {
        #region properties
        ...
        /// <summary>
        /// The WarrnatyReason property.
        /// </summary>
        public static readonly BindableProperty WarrnatyReasonProperty = BindableProperty.Create(
            nameof(WarrnatyReason),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
            BindingMode.TwoWay);
        ...
        /// <summary>
        /// WarrnatyReason value
        /// </summary>
        public string WarrnatyReason
        {
            get
            {
                return (string)GetValue(WarrnatyReasonProperty);
            }

            set
            {
                SetValue(WarrnatyReasonProperty, value);
            }
        }
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            else if (propertyName == WarrnatyReasonProperty.PropertyName)
            {
                lblWarrnatyReason.Text = WarrnatyReason;
            }
        ...
        public CustomRedirectedWarranty()
        {
            InitializeComponent();
        }
    }
