...
namespace WiseMobile.CustomControls.Card
{
    ...
    public partial class CustomReturnedCappedCasing : PancakeView
    {
        #region properties
        ...
        /// <summary>
        /// The ReturnReason property.
        /// </summary>
        public static readonly BindableProperty ReturnReasonProperty = BindableProperty.Create(
            nameof(ReturnReason),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
        ...
        /// <summary>
        /// The LastState property.
        /// </summary>
        public static readonly BindableProperty LastStateProperty = BindableProperty.Create(
            nameof(LastState),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
        ...
        public string ReturnReason
        {
            get
            {
                return (string)GetValue(ReturnReasonProperty);
            }

            set
            {
                SetValue(ReturnReasonProperty, value);
            }
        }
        ...
        public string LastState
        {
            get
            {
                return (string)GetValue(LastStateProperty);
            }

            set
            {
                SetValue(LastStateProperty, value);
            }
        }
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            else if (propertyName == ReturnReasonProperty.PropertyName)
            {
                lblReturnReason.Text = ReturnReason;
            }
            else if (propertyName == LastStateProperty.PropertyName)
            {
                lblLastState.Text = LastState;
            }
        ...
        public CustomReturnedCappedCasing()
        {
            InitializeComponent();
        }
    }
