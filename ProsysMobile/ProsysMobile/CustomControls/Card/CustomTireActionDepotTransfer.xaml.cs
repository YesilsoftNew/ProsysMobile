...
namespace ProsysMobile.CustomControls.Card
{
    ...
    public partial class CustomTireActionDepotTransfer : PancakeView
    {
        #region properties
        /// <summary>
        ...
        /// <summary>
        /// The ArrivalStockCenter property.
        /// </summary>
        public static readonly BindableProperty ArrivalStockCenterProperty = BindableProperty.Create(
            nameof(ArrivalStockCenter),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
            BindingMode.TwoWay);
        ...
        /// <summary>
        /// The ExitStockCenter property.
        /// </summary>
        public static readonly BindableProperty ExitStockCenterProperty = BindableProperty.Create(
            nameof(ExitStockCenter),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
            BindingMode.TwoWay);
        ...
        /// <summary>
        /// ArrivalStockCenter value
        /// </summary>
        public string ArrivalStockCenter
        {
            get
            {
                return (string)GetValue(ArrivalStockCenterProperty);
            }

            set
            {
                SetValue(ArrivalStockCenterProperty, value);
            }
        }

        /// <summary>
        /// ExitStockCenter value
        /// </summary>
        public string ExitStockCenter
        {
            get
            {
                return (string)GetValue(ExitStockCenterProperty);
            }

            set
            {
                SetValue(ExitStockCenterProperty, value);
            }
        }
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            else if (propertyName == ExitStockCenterProperty.PropertyName)
            {
                lblExitStockCenter.Text = ExitStockCenter;
            }
            else if (propertyName == ArrivalStockCenterProperty.PropertyName)
            {
                lblArrivalStockCenter.Text = ArrivalStockCenter;
            }
        ...
        public CustomTireActionDepotTransfer()
        {
            InitializeComponent();
        }
    }
