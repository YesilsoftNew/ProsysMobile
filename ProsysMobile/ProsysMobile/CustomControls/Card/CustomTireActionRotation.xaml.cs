...
namespace WiseMobile.CustomControls.Card
{
    ...
    public partial class CustomTireActionRotation : PancakeView
    {
        #region properties
        /// <summary>
        ...
        /// <summary>
        /// The PositionBeforeRotation property.
        /// </summary>
        public static readonly BindableProperty PositionBeforeRotationProperty = BindableProperty.Create(
            nameof(PositionBeforeRotation),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
            BindingMode.TwoWay);
        ...
        /// <summary>
        /// The PositionAfterRotation property.
        /// </summary>
        public static readonly BindableProperty PositionAfterRotationProperty = BindableProperty.Create(
            nameof(PositionAfterRotation),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
            BindingMode.TwoWay);
        ...
        /// <summary>
        /// PositionBeforeRotation value
        /// </summary>
        public string PositionBeforeRotation
        {
            get
            {
                return (string)GetValue(PositionBeforeRotationProperty);
            }

            set
            {
                SetValue(PositionBeforeRotationProperty, value);
            }
        }

        /// <summary>
        /// PositionAfterRotation value
        /// </summary>
        public string PositionAfterRotation
        {
            get
            {
                return (string)GetValue(PositionAfterRotationProperty);
            }

            set
            {
                SetValue(PositionAfterRotationProperty, value);
            }
        }
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            else if (propertyName == PositionAfterRotationProperty.PropertyName)
            {
                lblPositionAfterRotation.Text = PositionAfterRotation;
            }
            else if (propertyName == PositionBeforeRotationProperty.PropertyName)
            {
                lblPositionBeforeRotation.Text = PositionBeforeRotation;
            }
        ...
        public CustomTireActionRotation()
        {
            InitializeComponent();
        }
    }
