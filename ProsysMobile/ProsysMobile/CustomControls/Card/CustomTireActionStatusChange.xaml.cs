...
namespace WiseMobile.CustomControls.Card
{
    ...
    public partial class CustomTireActionStatusChange : PancakeView
    {
        #region properties
        /// <summary>
        ...
        /// </summary>
        public static readonly BindableProperty CurrentStatusProperty = BindableProperty.Create(
        ...
        /// </summary>
        public static readonly BindableProperty NewStatusProperty = BindableProperty.Create(
            nameof(NewStatus),
            typeof(string),
            typeof(CustomTireActionNewBuy),
            default(string),
        ...
        public string NewStatus
        {
            get
            {
                return (string)GetValue(NewStatusProperty);
            }
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            try
            {
                ...
                else if (propertyName == CurrentStatusProperty.PropertyName)
                {
                    lblCurrentStatus.Text = CurrentStatus;
                }
                else if (propertyName == NewStatusProperty.PropertyName)
                {
                    bdgNewStatus.Text = NewStatus;
                    bdgNewStatus.Type = enCustomBadgesType.Success;
                }
        ...
        public CustomTireActionStatusChange()
        {
            try
            {
