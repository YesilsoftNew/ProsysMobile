...
namespace WiseMobile.CustomControls.Entry
{
    ...
    public partial class CustomTreadDeptChannelsTertiary : Grid
    {
        ...
        public CustomTreadDeptChannelsTertiary()
        {
            InitializeComponent();
            ...
            try
            {
                ...
                MessagingCenter.Subscribe<object, string>("CustomTreadDeptChannelsTertiary", "BluetoothDataCommand", async (sender, arg) =>
                {
                    try
                    {
                ...
                MessagingCenter.Subscribe<object, enCustomBluetoothToolbar>("CustomTreadDeptChannelsTertiary", "BluetoothConnectionStausChanged", async (sender, arg) =>
                {
                    try
                    {
        ...
        protected virtual void OnDisappearing()
        {
            try
            {
                MessagingCenter.Unsubscribe<object, string>("CustomTreadDeptChannelsTertiary", "BluetoothDataCommand");
                MessagingCenter.Unsubscribe<object, enCustomBluetoothToolbar>("CustomTreadDeptChannelsTertiary", "BluetoothConnectionStausChanged");
            }
            catch (Exception ex)
            {
                WiseLogger.Instance.CrashLog(ex);
        ...
        public Command BluetoothDataCommand => new Command<string>(async (s) =>
        {
            ...
            try
            {
                if (!GlobalSetting.Instance.BluetoothGetDataRunning && string.IsNullOrWhiteSpace(s))
                {
                    ...
                    MessagingCenter.Send<object, enCustomBluetoothToolbar>("CustomTreadDeptChannelsTertiary", "BluetoothConnectionStausChanged", enCustomBluetoothToolbar.NotConnectedToDevice);
                    return;
                }
